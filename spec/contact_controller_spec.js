...
describe("ContactController", () => {
    ...
    describe("search methods", () => {
        ...
        describe("#iterativeSearch()", () => {
            ...
            it("should return null when searching an empty array", () => {
                    ...
                    this.book.addContact(...zelda).then(() => {
                        this.book.addContact(...magus).then(() => {
                            this.book.addContact(...snake).then(() => {
                                this.book.getContacts().then((contacts) => {
                                    let contact = this.book.binarySearch(sort(contacts), 'Zelda Smith');
                                    expect(contact.name).toBe('Zelda Smith');
                                    expect(contact.phone).toBe('000-100-111');
                                    expect(contact.email).toBe('zelda@nintendo.com');
                                    done();
                                }); 
                            });
                        });                       
    ...
    describe("delete()", () => {
        ...
        it("should delete the contact that matches the ID passed", (done) => {
            this.book.addContact("Rick Deckard", "000-000-000", "null@null.com")
            .then((contact) => {
                this.book.getContacts()
                .then((contacts) => {
